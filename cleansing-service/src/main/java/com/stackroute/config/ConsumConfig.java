...
public class ConsumConfig {
    ...
    public ConsumerFactory<String, Activities> consumerFactory(){
        ...
        return new DefaultKafkaConsumerFactory<>(config,new StringDeserializer(),
                new JsonDeserializer<>(Activities.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Activities> kafkaListener(){
        ConcurrentKafkaListenerContainerFactory<String, Activities> factory = new ConcurrentKafkaListenerContainerFactory();
