...
public class EmailService {
    ...
    @KafkaListener(topics = "CGI", groupId = "json")
    public void sendEmail(Domain domain) throws ArithmeticException, IOException {
        ...
        String domainEmail = properties.getProperty("General");
        if (domain.getDomainName().equals("Finance")) {
            domainEmail = properties.getProperty("Finance");

        }
        if (domain.getDomainName().equals("Legal")) {
            domainEmail = properties.getProperty("Legal");

        }
        if (domain.getDomainName().equals("HRM")) {
            domainEmail = properties.getProperty("HRM");
